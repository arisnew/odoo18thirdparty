...
class AccountBankStatementLine(models.Model):
    ...
    company_id = fields.Many2one(related="journal_id.company_id", inherited=False)
    ...
    def _reconcile_bank_line_keep(self, data):
        move = (
            ...
            .with_context(skip_invoice_sync=True,skip_readonly_check=True)
        ...
        with move._check_balanced(container):
            ...
            for line_vals in data:
                ...
                line = (
                    self.env["account.move.line"]
                    .with_context(check_move_validity=False, skip_invoice_sync=True, skip_readonly_check=True)
